...
const PLANS = [
  {
    id: "basic",
    name: "Basic",
    description: "Monitoraggio operativo essenziale con controllo simultaneo di più posizioni.",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      "Capacità di monitoraggio fino a 5 posizioni",
      "Soglie dei trade personalizzabili",
      "Storico delle ultime 10 notifiche",
      "Report operativo",
      "Architettura tecnica più solida",
    ],
    highlighted: true,
  },
] as const;
